...
WiFiClient client;
HTTPClient http;
#define URL_fw_Bin "https://raw.githubusercontent.com/quangtran3110/IOT/main/Arduino/DoThi/Phuong1/thpt2/build/esp8266.esp8266.nodemcuv2/thpt2.ino.bin"
String server_name = "http://sgp1.blynk.cloud/external/api/";
//-----------------------------
#define pin_terminal "&V35="
#define pin_G "&V36="
#define pin_mode "&V37="
String location = urlEncode("Phường 1 - Trường THPT 2 (Bên phải)\n");
//-----------------------------
struct Data {
  byte mode;
  byte reboot_num;
